...
namespace TD
{
    public class TowerButton : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler
    {
        [Header("Tower Type")]
        ...
        [SerializeField] private float touchDragThreshold = 20f; // Distance in pixels before detecting a drag
        ...
        void Awake()
        {
            ...
            // Add touch handler if it doesn't exist
            if (GetComponent<MobileUIButtonHandler>() == null)
            {
                gameObject.AddComponent<MobileUIButtonHandler>();
            }
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            if (Vector2.Distance(pointerDownPosition, eventData.position) < touchDragThreshold)
            {
                ...
                // Implement tower selection through click (for touch devices that have trouble with drag)
                SelectTowerForPlacement();
                towerPlacementManager.EnableTouchPlacementMode(towerType);
            }
        }
        ...
        public void OnEndDrag(PointerEventData eventData)
        {
            ...
            bool success = towerPlacementManager.TryPlaceTowerAtPosition(eventData.position);
        ...
        private void SelectTowerForPlacement()
        {
            ...
            // Add haptic feedback for mobile through our centralized system
            ProvideTouchFeedback();
        }
        
        private void ProvideTouchFeedback()
        {
            // Fallback to direct vibration call
